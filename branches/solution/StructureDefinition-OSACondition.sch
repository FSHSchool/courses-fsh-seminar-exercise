...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Condition">
      <sch:assert test="count(f:extension[@url = 'http://fshschool.org/courses-fsh-seminar-exercise/StructureDefinition/age-at-osa-diagnosis']) &lt;= 1">extension with URL = 'http://fshschool.org/courses-fsh-seminar-exercise/StructureDefinition/age-at-osa-diagnosis': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
